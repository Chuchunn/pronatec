 ...
 * @author aluno
 */
public class TabelaItensVenda extends javax.swing.JFrame {

    /**
     * Creates new form TabelaItensVenda
     */
    public TabelaItensVenda() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TabelaItensVenda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TabelaItensVenda().setVisible(true);
            }
        });
    }
